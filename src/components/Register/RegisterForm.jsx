...
export default function LoginForm() {
    ...
    return (    
        <form onSubmit={(e) => {
            ...
            <input onChange={(e) => setName(e.target.value)} type="text" id="name" className="w-[27rem] h-14 border-black border-[3px] rounded-lg text-2xl pl-1" />
            <label className="pl-2 text-lg self-start font-medium pt-1" htmlFor="email">E-mail</label>
            <input onChange={(e) => setEmail(e.target.value)} type="email" id="email" className="w-[27rem] h-14 border-black border-[3px] rounded-lg text-2xl pl-1" />
            <label className="pl-2 text-lg self-start font-medium pt-1" htmlFor="password">Password</label>
            <input onChange={(e) => setPassword(e.target.value)} type="password" id="password" className="w-[27rem] h-14 border-black border-[3px] rounded-lg text-2xl pl-1" />
            <label className="pl-2 text-lg self-start font-medium pt-1" htmlFor="confirm-password">Confirm Your Password</label>
            <input onChange={(e) => setPassword(e.target.value)} type="password" id="confirm-password" className="w-[27rem] h-14 border-black border-[3px] rounded-lg text-2xl pl-1" />
