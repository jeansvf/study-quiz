            ...
            <div className="flex">
                ...
                <div className="text-white w-1/3">
                    <div className="flex mb-1 relative items-center">
                        <p className="w-4 ml-3 mr-1">A)</p><input onChange={(e) => question.a = e.target.value} className="rounded-l-md text-black text-lg w-full" type="text" />
                        <CheckBox checkedId={checkedId} handleCheck={handleCheck} question={question} id={"a"} />
                    </div>
                    <div className="flex mb-1 relative items-center">
                        <p className="w-4 ml-3 mr-1">B)</p><input onChange={(e) => question.b = e.target.value} className="rounded-l-md text-black text-lg w-full" type="text" />
                        <CheckBox checkedId={checkedId} handleCheck={handleCheck} question={question} id={"b"} />
                    </div>
                    <div className="flex mb-1 relative items-center">
                        <p className="w-4 ml-3 mr-1">C)</p><input onChange={(e) => question.c = e.target.value} className="rounded-l-md text-black text-lg w-full" type="text" />
                        <CheckBox checkedId={checkedId} handleCheck={handleCheck} question={question} id={"c"} />
                    </div>
                    <div className="flex mb-1 relative items-center">
                        <p className="w-4 ml-3 mr-1">D)</p><input onChange={(e) => question.d = e.target.value} className="rounded-l-md text-black text-lg w-full" type="text" />
